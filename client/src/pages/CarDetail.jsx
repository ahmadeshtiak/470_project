              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4 pt-4 border-t">
                  ...
                  {user && car && car.seller && car.seller._id !== user.id && (
                    <button
                      onClick={() => navigate(`/exchange/${car._id}/car`)}
                      className="flex-1 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-2"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {user && (
                    <button
                      ...
                      className={`flex-1 font-semibold py-3 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-2 ${isSaved
