            ...
            <div className="max-w-3xl mx-auto">
                ...
                >
                    ...
                    <div className="flex justify-between items-start border-b-2 border-gray-200 pb-6 mb-6">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">🚗 MotorWala</h1>
                            <p className="text-gray-600 mt-1">An Innovation with Cars</p>
                            <p className="text-gray-500 text-sm mt-2">Dhaka, Bangladesh</p>
                            <p className="text-gray-500 text-sm">contact@motorwala.com</p>
                        </div>
                    ...
                    <div className="mt-12 pt-6 border-t border-gray-200 text-center">
                        {isQuote ? (
                            ...
                            <p className="text-gray-500 text-sm">
                                Thank you for your business! For any queries, contact us at support@motorwala.com
                            </p>
                        )}
